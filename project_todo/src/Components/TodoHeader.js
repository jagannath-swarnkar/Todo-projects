...
export default function PrimarySearchAppBar(props) {  
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem onClick={()=>{props.listShouldbe('Total')}}>
      ...
      <MenuItem onClick={()=>{props.listShouldbe('Done')}}>
        <IconButton aria-label="done-todos" color="inherit">
      ...
      <MenuItem onClick={()=>{props.listShouldbe('Pending')}}>
    ...
    <div className={classes.grow}>
      <AppBar position="static">
        <Toolbar>
          ...
          <Tooltip title="Total" onClick={()=>{props.listShouldbe('Total')}}>
            ...
            <Tooltip title="Done" onClick={()=>{props.listShouldbe('Done')}}>
              <IconButton aria-label="done-todos" color="inherit">
                <Badge badgeContent={done} color="secondary">
                  <CheckCircleSharpIcon />
                </Badge>
            ...
            <Tooltip title="Pending" onClick={()=>{props.listShouldbe('Pending')}}>
              <IconButton aria-label="pending-todos" color="inherit">
                <Badge badgeContent={pending} color="secondary">
                  <CancelSharpIcon />
                </Badge>
